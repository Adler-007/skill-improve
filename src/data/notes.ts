...
export const notes: Note[] = [
    ...
    content: [
      ...
      },
      {
        ...
        items: [
          ...
          "把任务拆成数据、页面、交互和验证几个层次。",
          "每次改动后运行类型检查或构建，确认静态站点能正常生成。",
        ],
      },
      {
        type: "heading",
  ...
  },
  {
    ...
    content: [
      {
        type: "paragraph",
        text: "项目复盘的目标是形成下一次可复用的判断，而不是简单记录发生了什么。最小结构需要覆盖目标、过程、偏差、原因和行动项。",
      },
      {
        type: "heading",
        id: "template",
      ...
      },
      {
        ...
        items: [
          ...
          "关键过程：哪些节点改变了项目走向。",
          "结果偏差：实际结果和预期之间有什么差异。",
          "原因判断：哪些假设、资源或协作机制导致偏差。",
          "后续行动：下一次应该保留、调整或删除什么做法。",
        ],
      },
      {
        type: "heading",
      ...
      {
        type: "paragraph",
        text: "好的复盘应该能让一个没有参与项目的人，在十分钟内理解项目的关键判断和主要经验。",
      },
    ],
  },
];
